...
void main() {
  group('Admin Beasiswa test group', () {
    ...
    testWidgets('Verify the presence of admin beasiswa widgets', (WidgetTester tester) async {
    ...
    testWidgets('Verify the behavior of admin beasiswa FloatingActionButton', (WidgetTester tester) async {
      await tester.pumpWidget(MaterialApp(home: BeasiswaAdmin()));
